                ...
                <div className="mx-10 px-4">
                    <div className="grid grid-cols-3 gap-10">
                        <div className="flex-col">
                            <h2 className="w-[120px] font-semibold mb-6 pb-[5px] border-b-2 border-white">CONTACT US</h2>
                        ...
                        <div className="flex-col">
                            <h2 className="w-[120px] font-semibold mb-6 pb-[5px] border-b-2 border-white">ABOUT US</h2>
                        ...
                        <div className="flex-col">
                            <h2 className="w-[120px] font-semibold mb-6 pb-[5px] border-b-2 border-white">FOLLOW US</h2>
