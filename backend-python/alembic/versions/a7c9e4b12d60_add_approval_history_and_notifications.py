...
def create_approval_history_table() -> None:
    op.create_table(
        "approval_histories",
...
def create_approval_history_indexes() -> None:
...
def upgrade() -> None:
    if context.is_offline_mode():
        ...
        create_approval_history_indexes()
    ...
    existing_indexes = {
        index["name"]
        for index in inspector.get_indexes("approval_histories")
    }
    for index_name, column_name in (
        ("ix_approval_histories_restaurant_id", "restaurant_id"),
        ("ix_approval_histories_manager_id", "manager_id"),
